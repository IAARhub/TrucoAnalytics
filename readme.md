...
| ------------- |:-------------:|:-------------:|:-------------:|
| Ir a la pesca         | Se tiene tanto o truco medio o alto, no se canta y se espera a que el contrincante cante para doblar la apuesta o aceptar.    | mano_jugador.ranking = "Medio" || mano_jugador.ranking = "Alto" && numero_ronda = 1 && turno_actual = "Yo" | check
